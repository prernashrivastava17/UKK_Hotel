...
export default class TypeRoom extends React.Component {
    ...
    handleSave = (e) => {
        ...
        if (this.state.action === "insert") {
            ...
            let url = "http://localhost:8000/tipekamar/" + this.state.id
    ...
    handleDrop = (id) => {
        let url = "http://localhost:8000/tipekamar/" + id
    ...
    _handleFilter = () => {
        ...
        let url = "http://localhost:8000/tipekamar/find/"
                                        ...
                                        <div className="CardEvent" key={index}>
                                            <div className="max-w-sm rounded overflow-hidden shadow-lg border-2 border-gray-200 bg-gray-100">
                                                <div className='container'>
                                                    <img className="w-full h-48" src={"http://localhost:8000/foto/" + item.foto} />
                                                    {this.state.role === "admin" &&
                                                        <>
                    ...
                    <div className="flex lg:h-auto w-auto justify-center ">
                        <div className="relative bg-white rounded-lg shadow dark:bg-white w-1/3">
                            ...
                            <div className="px-6 py-6 lg:px-8">
                                <h3 className="mb-4 text-xl font-medium text-gray-900 dark:text-black">Edit Type Room</h3>
                ...
                <div id="modal_detail" tabindex="-1" className="overflow-x-auto fixed top-0 left-0 right-0 z-50 hidden w-full pt-10 pb-10 pl-96 md:inset-0 h-modal md:h-full bg-tranparent bg-black bg-opacity-50" >
                    <div className="relative w-full h-full max-w-lg md:h-auto border-2 border-gray-500 rounded-lg shadow shadow-2xl items-center">
                        <div className="relative bg-white rounded-lg">
                            ...
                            <div className="p-6">
                                <div className='container'>
                                    <img className="rounded-md w-200 h-100" src={"http://localhost:8000/foto/" + this.state.foto} />
                                </div>
